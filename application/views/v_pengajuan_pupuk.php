                                        ...
                                        <?php $no=1; foreach ($pengajuanpupuk as $key => $value) {?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?= base_url('pengajuan/update/'.$value->id_pengajuan) ?>" class="btn btn-sm btn-success"  
                                                    onclick="return confirm('Apakah Data Ingin Diterima?..')">Terima</a>
                                                    <a href="<?= base_url('pengajuan/hapus/'.$value->id_pengajuan)?>" class="btn btn-sm btn-danger"
